...
\begin{frame}{Objectifs de la modélisation}
  \begin{block}{Objectifs}
	...
	\begin{itemize}
		...
		\item<7-> Représentation des états intermédiaires non nécessaires %todo reprendre etat sinal = état initial
...
\begin{frame}{État de l'art des modèles de développement résidentiel}
	\only<1>{Les modèles d'\textbf{occupation du sol} (Batty 199797, Arentze 2008, Tannier 2010, Mustapha 2018). %todo ajouter images?! peut être en mettre un tout petit peu plus
		\begin{itemize}
...
\begin{frame}{Validation de différentes configurations spatiales de \\MUP-City}
	...
	\end{block}}
	\only<3>{\begin{block}{}
		Scénario de \textbf{développement} résidentielle \textbf{ciblée}
	\\
		\vspace{0.4cm}
