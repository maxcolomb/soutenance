...
\begin{frame}{Objectifs de la modélisation}
	...
	\begin{itemize}
		\small
		\item<1-> Evaluer le développement résidentiel à différents niveaux d'échelle et selon les contraintes issues de la réglementation
...
\begin{frame}{État de l'art des modèle de développement résidentiel}
	...
	\end{itemize}}
	\only<3>{
	Les modèles d'\textbf{occupation du sol} (Batty 97, Mustapha 18) premettent de %TODO ref
	\begin{itemize}
		\item Simuler le changement d'état et l'urbanisation 
		\item Propose des prédictions sur l'état du marché et sur les futures urbanisations
	\end{itemize}
	Inconvénients~: 
	\begin{itemize}
...
%	\end{block}}
	\begin{block}{}
		Développer un nouvel outil d'aide à la décision dans l'aménagement, couplant différentes approches de simulation du développement résidentiel, appelé \textbf{ArtiScales}
	\end{block}
\end{frame}
...
\vspace{1cm}
\centering{\includegraphics[width=12cm]{Images/MUP/illuYagMoy.png}}
...
\section{Expérimentation d'ArtiScales sur l'agglomération du Grand Besançon}
...
\begin{frame}{ArtiScales : Densité nette de logements par $m^{2}$}
			\only<1>{\centering{\includegraphics[width=9cm]{Images/dens/dens0.png}}}
			\only<2>{\centering{\includegraphics[width=9cm]{Images/dens/dens1.png}}}
			\only<3>{\centering{\includegraphics[width=9cm]{Images/dens/dens2.png}}}
\end{frame}

\begin{frame}{ArtiScales : Simulation de logements}
			\only<1>{\centering{\includegraphics[width=9cm]{Images/lgt/lgt0.png}}}
			\only<2>{\centering{\includegraphics[width=9cm]{Images/lgt/lgt1.png}}}
\end{frame}
...
\begin{frame}{ArtiScales : Simulation de logements}
	\begin{table}[h]
		...
		\tiny
		\begin{center}
		\begin{tabular}{m{2.4cm}m{1.2cm}m{1.1cm}m{1cm}m{1cm}m{1cm}m{1cm}}
				\rowcolor[gray]{0.8}
