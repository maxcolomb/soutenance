...
%			\item Très contextualisé
	\end{itemize}}
	\only<3>{Ces outils sont appliqués à la résolution d'\textbf{un} problème défini et sont \textbf{peu interopérables}}
\end{frame}
...
\vspace{1cm}
\centering{\includegraphics[width=12cm]{Images/MUP/illuYagMoy.png}} %TODO changer l'image + légende
