...
\begin{frame}{Enjeux : concordance des documents d'urbanisme}
	...
	\uncover<2->{	
		\begin{block}{}
			\textbf{Anticiper} leurs effets afin d'améliorer leurs \textbf{concordance} %et d'expliciter leurs \textbf{}
		\end{block}
	}
\end{frame}
...
\begin{block}{}
	...
	\begin{itemize}
		...
		\item Prise en compte des mécanismes de développement résidentiel et des contraintes des documents d'aménagement
...
Faire un tableau avec les avantages et les inconvénients des différentes approches
	...
	\end{itemize}
	\uncover<2->{MUP-City (Morphologique multi-fractale sous contrainte multi objective)\\
	modèle stylisé
}
\end{frame}
...
\begin{frame}
	...
	\uncover<2->{
		\begin{block}{}
			Application à la communauté d'agglomération du Grand Besançon (est de la France)
		\end{block}
	}
\end{frame}
