...
\begin{itemize}
		\small
		\item Solutions libres et open-source pour une recherche \textbf{vérifiable} et \textbf{reproductible}
...
\begin{frame}{État de l'art des modèle de développement résidentiel}
	\only<1>{Les modèles d'\textbf{occupation du sol} (Batty 97, Arentze 08, Mustapha 18).
		\begin{itemize}
...
\begin{frame}{Présentation du modèle}
 	\centering
 \only<1>{\includegraphics[width=10cm]{Images/schemGenParcelManager-prez-1.png}}
 \only<2>{\includegraphics[width=10cm]{Images/schemGenParcelManager-prez0.png}}
 \only<3>{\includegraphics[width=10cm]{Images/schemGenParcelManager-prez1.png}}
 \only<4>{\includegraphics[width=10cm]{Images/schemGenParcelManager-prez2.png}}
\end{frame}
