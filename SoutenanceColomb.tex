...
\begin{frame}{Objectifs de la modélisation}
	...
	\vspace{-0.2cm}
		\small
		\item<1-> Simuler et évaluer le développement résidentiel à différents niveaux d'échelle selon les contraintes issues de la réglementation
...
\begin{frame}{État de l'art des modèle de développement résidentiel}
...
\section{Expérimentation d'ArtiScales sur l'aire urbaine de Besançon}
