...
\title{\vspace{1cm}Simulation de formes réalistes de développement résidentiel, de l'échelle du bâtiment à celle de l'ensemble d'une région urbaine}
\author{Maxime Colomb}
\subtitle{\footnotesize\textit{Sous la direction de Mickaël Brasebin, Julien Perret \& Cécile Tannier}
  \\Soutenance de thèse
\\ {\tiny\'Ecole doctorale MSTIC - spécialité ``sciences et technologies de l'information géographique''}}

\titlegraphic{\vspace{-0.5cm}\includegraphics[height=1.1cm]{Images/logoIGN.png}\hfill\includegraphics[height=1.1cm]{Images/logoThema.jpg}\hfill\includegraphics[height=0.6cm]{Images/logo-upe.png}}
