...
\begin{frame}{Contexte : le phénomène d'étalement urbain}
	\begin{block}{}
		\begin{itemize}
			\item Urbanisation désordonnée de terrains non-bâtis en marge des centres urbains
			\begin{itemize}
		...
		\includegraphics[height=2.8cm]{Images/maiz.jpg}
	\end{block}
\end{frame}
...
\begin{frame}{Objectifs de la modélisation}
	...
	\begin{itemize}
		\small
		\item Modélisation descriptive
		\item<7-> Passage d'un état initial à un état final %Représentation des états intermédiaires non nécessaires, on ne simule pas une évolution
...
\begin{frame}{État de l'art des modèles de développement résidentiel}
	\only<1>{Les modèles d'\textbf{occupation du sol} (Batty 1997, Arentze 2008, Tannier 2010, Mustapha 2018). %todo ajouter images?! peut être en mettre un tout petit peu plus ?
		\begin{itemize}
			...
			\begin{itemize}
				...
				\item Prévisionnel (marché immobilier, changements démographiques)
				\item Prospectif (évolutions possibles)
			\end{itemize}
%			\item Mise en œuvre de multiples techniques (automates cellulaires, systèmes multi-agents, aide à la décision multi-critère...) %todo trouver une raison à l'oral ou suppr hétérogé
		\end{itemize}
...
\begin{frame}{Problématique}
	...
	afin d'identifier et d'explorer les effets combinés	des différents types de \textbf{documents de planification et d'urbanisme} ?}
\end{frame}
...
\setbeamertemplate{section page}[progressbarcomplete]
...
\subsection[Parcel Manager]{Parcel Manager pour la gestion du parcellaire}
\begin{frame}
\subsectionpage
\end{frame}
...
\begin{frame}{MUP-City : caractère extensif ou non de \\l'extension résidentielle}
	\vspace{1cm}
	\hspace*{-0.5cm}\centering{\includegraphics[width=11cm]{Images/MUP/illuYagMoy.png}}
...
\begin{frame}{Validation de différentes configurations spatiales de \\MUP-City}
	...
	\end{block}}
	\only<3>{\begin{block}{}
		Scénario de \textbf{développement} résidentiel \textbf{ciblée}
	\\
		\vspace{0.4cm}
	...
	\only<6>{
		...
		Scénario d'\textbf{intensification} de la densité résidentielle
			\begin{itemize}
				...
				\item Taille des cellules selon différents types de zonage
			\end{itemize}
		\end{block}	
	}
...
\begin{frame}{MUP-City : conclusion de l'analyse de variabilité}
	\begin{block}{Conclusion}
		La variation des paramètres techniques n'ont pas les mêmes effets selon les scénarios
	\end{block}
...
\\
	\textbf{Distribution} sur divers environnements grâce à OpenMOLE
	\begin{itemize}
		\small
...
\begin{frame}{ArtiScales : Densité nette de logements par hectare}
...
\only<1>{\hspace*{-0.9cm}\centering{\includegraphics[width=12.5cm]{Images/compVar/compSeed.png}}}
\only<2>{\hspace*{-0.9cm}\centering{\includegraphics[width=12.5cm]{Images/compVar/compSCell.png}}}
\end{frame}
...
\begin{frame}{Incompatibilité entre les documents}
	Incompatibilité entre les objectifs de création de logements et les documents d'urbanisme %(objectifs sur-dimensionnés ?)
	\\
	\only<1>{\includegraphics[width=11cm]{cartes/NancrayDDense3D.png}}
	\only<2>{\includegraphics[width=11cm]{cartes/NancrayDPD3D.png}}
	\only<3>{\includegraphics[width=11cm]{cartes/AvanneRNUInf.png}}
\end{frame}

\begin{frame}{Incompatibilité entre les documents \\ Rétro-action sur le zonage}
	\only<1>{\includegraphics[width=9cm]{Images/schemCompatibleResult-prez0.png}}
	\only<2>{\includegraphics[width=9cm]{Images/schemCompatibleResult-prez1.png}}
	\only<3>{\includegraphics[width=9cm]{Images/schemCompatibleResult-prez2.png}}
%
\end{frame}
